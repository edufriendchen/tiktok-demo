...
func (getFollowListService *GetFollowListService) GetFollowList(ctx context.Context, session neo4j.SessionWithContext, user *user.CheckUserRequest) (int64, error) {

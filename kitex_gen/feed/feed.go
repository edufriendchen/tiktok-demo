...
type FeedRequest struct {
	LatestTime *int64  `thrift:"latest_time,1,optional" frugal:"1,optional,i64" json:"latest_time" query:"latest_time"`
	Token      *string `thrift:"token,2,optional" frugal:"2,optional,string" json:"token" query:"token"`
}

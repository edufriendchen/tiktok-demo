...
type ActionRequest struct {
	Data  []byte `thrift:"data,1,required" frugal:"1,required,binary" json:"data" query:"data"`
	Token string `thrift:"token,2,required" frugal:"2,required,string" json:"token" query:"token"`
	Title string `thrift:"title,3,required" frugal:"3,required,string" json:"title" query:"title"`
}

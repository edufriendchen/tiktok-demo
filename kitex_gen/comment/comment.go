...
type ActionRequest struct {
	...
	CommentText *string `thrift:"comment_text,4,optional" frugal:"4,optional,string" json:"comment_text" query:"comment_text"`
	CommentId   *string `thrift:"comment_id,5,optional" frugal:"5,optional,string" json:"comment_id" query:"comment_id"`
}
...
var ActionRequest_CommentId_DEFAULT string

func (p *ActionRequest) GetCommentId() (v string) {
	if !p.IsSetCommentId() {
...
func (p *ActionRequest) SetCommentId(val *string) {
	p.CommentId = val
}
...
func (p *ActionRequest) Field5DeepEqual(src *string) bool {
...
type CommentRequest struct {
	...
	VideoId string `thrift:"video_id,2,required" frugal:"2,required,string" json:"video_id" query:"video_id"`
}
